...
exports.bookinstance_delete_post = function (req, res, next) {
  ...
  BookInstance.findByIdAndRemove(req.body.bookinstanceid, function deleteBookInstance(err, deletedInstance) {
    if (err) { return next(err); }
    // Success - go to book

    res.redirect('/catalog/book/' + deletedInstance.book)
  })
};
...
exports.bookinstance_update_get = function (req, res, next) {
  ...
  //use aynsc to get the book instance and a list of all books
  async.parallel({
    ...
    function (err, results) {
      if (err) { return next(err); }
      // Success
      res.render('bookinstance_form', { title: 'Update Book Instance', bookinstance: results.thebookinstance, book_list: results.book_list })
    })
